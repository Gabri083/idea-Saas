const es = {
  ...
  admin: {
    ...
    calibration: {
      ...
      businessFallback: "Negocio",
      issueLabel: "Problema: ",
      occurrencesLabel: (n: number) => `(${n} quejas)`,
      evidenceLabel: "Evidencia de corrección: ",
      affectedReviews: (n: number) => `${n} reseñas históricas asociadas.`,
...
const en: typeof es = {
  ...
  admin: {
    ...
    calibration: {
      ...
      businessFallback: "Business",
      issueLabel: "Issue: ",
      occurrencesLabel: (n: number) => `(${n} complaints)`,
      evidenceLabel: "Correction evidence: ",
      affectedReviews: (n: number) => `${n} historical reviews affected.`,
