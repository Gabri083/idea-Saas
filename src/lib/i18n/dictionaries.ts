const es = {
  ...
  founders: {
    ...
    successBody:
      "Crea tu cuenta con el mismo correo que usaste aquí y tu 30% de descuento se aplica automático al pagar.",
    goToSignupCta: "Crear mi cuenta y pagar",
    ...
    apiDuplicate: "Ese negocio o correo ya está en la lista de fundadores.",
...
const en: typeof es = {
  ...
  founders: {
    ...
    successBody: "Create your account with the same email you used here and your 30% discount applies automatically at checkout.",
    goToSignupCta: "Create my account and pay",
    ...
    apiDuplicate: "That business or email is already on the founders list.",
